...
var day = parseInt(prompt("1st day of month, (1-7) where 1 is sunday and 7 is Saturday: "));
...
else
{
    ...
    var etextnode = document.createTextNode("Invalid Entries");
    e.appendChild(etextnode);
